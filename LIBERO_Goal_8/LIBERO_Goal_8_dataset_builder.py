...
from LIBERO_Goal_8.conversion_utils import MultiThreadedDatasetBuilder
...
class PutTheBowlOnThePlate(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob(
                "/home/changyeon/libero_datasets/hdf5/libero_goal_no_noops/put_the_bowl_on_the_plate_demo.hdf5"
            ),
        }
