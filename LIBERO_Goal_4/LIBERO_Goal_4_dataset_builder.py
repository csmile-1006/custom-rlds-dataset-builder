...
from LIBERO_Goal_4.conversion_utils import MultiThreadedDatasetBuilder


def _get_features_dict():
    """Returns the common features dictionary for all LIBERO Goal datasets."""
...
class PutTheBowlOnTopOfTheCabinet(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob(
                "/home/changyeon/libero_datasets/hdf5/libero_goal_no_noops/put_the_bowl_on_top_of_the_cabinet_demo.hdf5"
            ),
        }
