...
from LIBERO_Object_4.conversion_utils import MultiThreadedDatasetBuilder
...
class PickUpTheCreamCheeseAndPlaceItInTheBasket(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob(
                "/home/changyeon/libero_datasets/hdf5/libero_object_no_noops/pick_up_the_cream_cheese_and_place_it_in_the_basket_demo.hdf5"
            ),
        }
