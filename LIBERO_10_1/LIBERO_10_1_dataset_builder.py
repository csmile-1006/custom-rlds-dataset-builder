...
from LIBERO_10_1.conversion_utils import MultiThreadedDatasetBuilder
...
class PutBothMokaPotsOnTheStove(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob(
                "/home/changyeon/libero_datasets/hdf5/libero_10_no_noops/put_both_moka_pots_on_the_stove_demo.hdf5"
            ),
        }
