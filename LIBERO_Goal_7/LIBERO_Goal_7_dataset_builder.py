...
from LIBERO_Goal_7.conversion_utils import MultiThreadedDatasetBuilder
...
class TurnOnTheStove(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob(
                "/home/changyeon/libero_datasets/hdf5/libero_goal_no_noops/turn_on_the_stove_demo.hdf5"
            ),
        }
