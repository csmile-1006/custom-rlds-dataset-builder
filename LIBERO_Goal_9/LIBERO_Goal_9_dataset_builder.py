...
from LIBERO_Goal_9.conversion_utils import MultiThreadedDatasetBuilder
...
class PutTheWineBottleOnTheRack(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob(
                "/home/changyeon/libero_datasets/hdf5/libero_goal_no_noops/put_the_wine_bottle_on_the_rack_demo.hdf5"
            ),
        }
