...
from LIBERO_10_8.conversion_utils import MultiThreadedDatasetBuilder
...
class PutTheYellowAndWhiteMugInTheMicrowaveAndCloseIt(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob(
                "/home/changyeon/libero_datasets/hdf5/libero_10_no_noops/put_the_yellow_and_white_mug_in_the_microwave_and_close_it_demo.hdf5"
            ),
        }
