...
from LIBERO_10_2.conversion_utils import MultiThreadedDatasetBuilder


def _get_features_dict():
    """Returns the common features dictionary for all LIBERO 10 datasets."""
...
class PutBothTheAlphabetSoupAndTheCreamCheeseBoxInTheBasket(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob(
                "/home/changyeon/libero_datasets/hdf5/libero_10_no_noops/put_both_the_alphabet_soup_and_the_cream_cheese_box_in_the_basket_demo.hdf5"
            ),
        }
