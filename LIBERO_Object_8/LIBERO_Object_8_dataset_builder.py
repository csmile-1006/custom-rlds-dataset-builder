...
from LIBERO_Object_8.conversion_utils import MultiThreadedDatasetBuilder


def _get_features_dict():
    """Returns the common features dictionary for all LIBERO Object datasets."""
...
class PickUpTheSaladDressingAndPlaceItInTheBasket(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob(
                "/home/changyeon/libero_datasets/hdf5/libero_object_no_noops/pick_up_the_salad_dressing_and_place_it_in_the_basket_demo.hdf5"
            ),
        }
