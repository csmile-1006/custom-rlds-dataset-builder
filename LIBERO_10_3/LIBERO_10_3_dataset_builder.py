...
from LIBERO_10_3.conversion_utils import MultiThreadedDatasetBuilder
...
class PutBothTheAlphabetSoupAndTheTomatoSauceInTheBasket(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob(
                "/home/changyeon/libero_datasets/hdf5/libero_10_no_noops/put_both_the_alphabet_soup_and_the_tomato_sauce_in_the_basket_demo.hdf5"
            ),
        }
