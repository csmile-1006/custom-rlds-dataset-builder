...
from LIBERO_Object_1.conversion_utils import MultiThreadedDatasetBuilder
...
class PickUpTheBbqSauceAndPlaceItInTheBasket(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob(
                "/home/changyeon/libero_datasets/hdf5/libero_object_no_noops/pick_up_the_bbq_sauce_and_place_it_in_the_basket_demo.hdf5"
            ),
        }
